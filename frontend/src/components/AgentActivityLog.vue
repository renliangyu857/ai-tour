...
.log-entry.AGENT_TOOL_CALL .log-message  { color: rgba(184,146,58,0.8); }
.log-entry.DEBATE_INITIATED .log-message { color: rgba(184,146,58,0.7); }
.log-entry.CONSENSUS_REACHED .log-message { color: rgba(184,146,58,0.7); }
