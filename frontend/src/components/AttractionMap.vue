...
const CAT_COLORS: Record<string, { bg: string; text: string; border: string; marker: string }> = {
  landmark: { bg: 'rgba(28,56,41,0.08)', text: '#1C3829', border: 'rgba(28,56,41,0.3)', marker: '#1C3829' },
  ...
  food:     { bg: 'rgba(184,146,58,0.08)', text: '#B8923A', border: 'rgba(184,146,58,0.3)', marker: '#B8923A' },
}
...
function renderMarkers(L: any) {
  ...
  for (const attr of ATTRACTIONS) {
    const color = CAT_COLORS[attr.category]?.marker || '#1C3829'
...
.am-cat:hover { border-color: rgba(184,146,58,0.4); color: #B8923A; }
.am-cat.active {
...
.am-route-toggle.active {
  background: rgba(28,56,41,0.3);
  border-color: rgba(28,56,41,0.8);
  color: #6EE7A0;
}
...
.am-rp-nav-btn.export { background: rgba(184,146,58,0.1); border-color: rgba(184,146,58,0.25); color: #D4A84B; }
.am-rp-nav-btn.export:hover { background: rgba(184,146,58,0.18); }
...
.am-detail-tips {
  ...
  border-left: 2px solid rgba(184,146,58,0.3);
  padding: 7px 12px;
...
.am-action-btn.primary {
  background: rgba(28,56,41,0.6);
  border-color: rgba(28,56,41,0.9);
  color: #6EE7A0;
}
.am-action-btn.primary:hover { background: rgba(28,56,41,0.85); }
...
.am-action-btn.secondary:hover { border-color: rgba(184,146,58,0.35); color: #D4A84B; }
</style>
...
.am-pin::before {
  ...
  background: var(--pin-color, #1C3829);
