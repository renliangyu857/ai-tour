...
.drawer {
  ...
  box-shadow: -8px 0 48px rgba(28,56,41,0.18);
}
...
/* ── Init banner ─── */
.init-section { background: rgba(184,146,58,0.06); border-color: rgba(184,146,58,0.3); }
...
.badge-enabled { color: var(--forest); border-color: rgba(28,56,41,0.25); background: rgba(28,56,41,0.06); }
