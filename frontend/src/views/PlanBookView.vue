...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .summary { font-size: 14px; color: #555; line-height: 1.7; margin-bottom: 32px; border-left: 3px solid #B8923A; padding-left: 14px; }
  .day { margin-bottom: 40px; padding-bottom: 32px; border-bottom: 1px solid #eee; }
  .day:last-child { border-bottom: none; }
  h2 { font-size: 18px; font-weight: 700; color: #1C3829; margin-bottom: 6px; }
...
.sb-nav-item.active { color: var(--gold); background: rgba(184,146,58,0.12); }
...
.sb-plan-item.active { background: rgba(184,146,58,0.1); border-color: rgba(184,146,58,0.3); }
...
.es-btn:hover { background: rgba(28,56,41,0.14); }
...
.ph-action-btn.export {
  ...
  border-color: rgba(28,56,41,0.12);
  color: var(--forest);
}
.ph-action-btn.export:hover { background: rgba(28,56,41,0.13); }
...
.dn-arrow:hover:not(:disabled) { border-color: var(--forest); color: var(--forest); background: rgba(28,56,41,0.05); }
