...
public class CrossValidator {
    ...
    public CrossValidator(@Lazy AgentRegistry agentRegistry) {
    ...
    private List<String> determineParticipants(List<String> issues) {
        ...
        for (String issue : issues) {
            if (issue.contains("activity time") || issue.contains("outdoor")) {
                participants.add("day-scheduling");
            }
            if (issue.contains("Route") || issue.contains("leg")) {
                participants.add("route-optimization");
            }
            if (issue.contains("Budget")) {
                participants.add("budget-planning");
            }
            if (issue.contains("weather")) {
