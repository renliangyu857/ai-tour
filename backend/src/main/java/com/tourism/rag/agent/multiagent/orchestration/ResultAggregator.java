...
public class ResultAggregator {
    ...
    public ItineraryResponse aggregate(AgentContext ctx, String itineraryId,
        ...
        List<ToolCallLog> toolLogs = buildToolCallLogs(allResults);
    ...
    private List<TimeSlotActivity> getDayActivities(Map<String, AgentResult> results,
        ...
        if (val instanceof List<?> list && !list.isEmpty()
                && list.get(0) instanceof TimeSlotActivity) {
    ...
    private List<ToolCallLog> buildToolCallLogs(Map<String, AgentResult> results) {
